...
with open('C:\\Users\\DarkStell\\Documents\\GitHub\\Interpolaitcia\\5.txt', 'r') as f:
    str = f.readline()
    fun =  parse_expr(str)
    a = float(f.readline())
    b = float(f.readline())
...
with open('C:\\Users\\DarkStell\\Documents\\GitHub\\Interpolaitcia\\результат.txt', 'w') as file:
